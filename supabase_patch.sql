...
-- BOT USERS extra columns (add if missing) --------------------------
ALTER TABLE bot_users ADD COLUMN IF NOT EXISTS trial_used     BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE bot_users ADD COLUMN IF NOT EXISTS trial_expiry   TIMESTAMPTZ;
ALTER TABLE bot_users ADD COLUMN IF NOT EXISTS premium_expiry TIMESTAMPTZ;
...
ALTER TABLE bot_users ADD COLUMN IF NOT EXISTS referral_count INT NOT NULL DEFAULT 0;
