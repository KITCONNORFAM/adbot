...
Êœá´‡Ê <code>{first_name}</code> á´¡á´‡ÊŸá´„á´á´á´‡ á´›á´ Êá´á´œÊ€ á´˜á´‡Ê€sá´É´á´€ÊŸ á´€á´…á´ á´‡Ê€á´›ÉªsÉªÉ´É¢ á´„á´€á´› á´€á´…Ê™á´á´› Ê™Ê á´Éªá´…É´ÉªÉ¢Êœá´› êœ°á´‡á´…á´‡Ê€á´€á´›Éªá´É´ (OWNER @CHARLIESPRINGFAM)

<blockquote>ðŸ“¢ á´€á´œá´›á´á´á´€á´›á´‡á´… á´€á´…á´ á´‡Ê€á´›ÉªsÉªÉ´É¢ ÉªÉ´ É¢Ê€á´á´œá´˜s
ðŸ’¬ á´€á´œá´›á´ Ê€á´‡á´˜ÊŸÊ á´›á´ á´…ÉªÊ€á´‡á´„á´› á´á´‡ssá´€É¢á´‡s
ðŸ”— á´€á´œá´›á´ á´Šá´ÉªÉ´ É¢Ê€á´á´œá´˜s á´ Éªá´€ ÊŸÉªÉ´á´‹s
ðŸ“Š á´…á´‡á´›á´€ÉªÊŸá´‡á´… sá´›á´€á´›Éªsá´›Éªá´„s á´›Ê€á´€á´„á´‹ÉªÉ´É¢
ðŸ‘¤ á´á´œÊŸá´›Éªá´˜ÊŸá´‡ á´€á´„á´„á´á´œÉ´á´› sá´œá´˜á´˜á´Ê€á´›
...
<blockquote>Êá´á´œ á´á´œsá´› á´Šá´ÉªÉ´ á´›Êœá´‡ Ò“á´ÊŸÊŸá´á´¡ÉªÉ´É¢ á´„Êœá´€É´É´á´‡ÊŸs/É¢Ê€á´á´œá´˜s á´›á´ á´œsá´‡ á´›ÊœÉªs Ê™á´á´›:</blockquote>
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if db.is_banned(user_id):
        await query.answer("ðŸš« You are banned from using this bot.", show_alert=True)
        return
    ...
    if data == "main_menu":
        ...
        await send_new_message(
            query,
            "<b>â–£ á´€á´…á´ á´‡Ê€á´›ÉªsÉªÉ´É¢ sá´›á´á´˜á´˜á´‡á´…</b>\n\nâœ“ <i>Êá´á´œÊ€ á´„á´€á´á´˜á´€ÉªÉ¢É´ Êœá´€s Ê™á´‡á´‡É´ sá´›á´á´˜á´˜á´‡á´… sá´œá´„á´„á´‡ssÒ“á´œÊŸÊŸÊ.</i>",
...
async def show_main_menu(query, context=None):
    ...
    # â”€â”€ Live expiry display for premium / trial users
    expiry_line = ""
    if role in ("premium", "trial"):
        expiry = db.get_premium_expiry(user_id)
        if expiry:
            expiry_str = expiry.strftime("%d %b %Y, %H:%M UTC")
            icon = "ðŸŽ" if role == "trial" else "ðŸ’Ž"
            label = "Trial" if role == "trial" else "Premium"
            expiry_line = f"\n{icon} <b>{label} active</b> â€” expires <b>{expiry_str}</b>\n"
        else:
            expiry_line = "\nâš ï¸ <i>Expiry date not found â€“ contact support</i>\n"
...
async def show_support(query):
    support_text = """
<b>ðŸ’¬ sá´œá´˜á´˜á´Ê€á´› & Êœá´‡ÊŸá´˜ á´„á´‡É´á´›á´‡Ê€</b>

<blockquote expandable>ðŸ†˜ <b>É´á´‡á´‡á´… á´€ssÉªsá´›á´€É´á´„á´‡?</b>
á´¡á´‡'Ê€á´‡ Êœá´‡Ê€á´‡ á´›á´ Êœá´‡ÊŸá´˜ Êá´á´œ 24/7!

ðŸ“Œ <b>Ç«á´œÉªá´„á´‹ Êœá´‡ÊŸá´˜:</b>
â€¢ É¢á´‡á´›á´›ÉªÉ´É¢ sá´›á´€Ê€á´›á´‡á´…: á´€á´…á´… Êá´á´œÊ€ á´›á´‡ÊŸá´‡É¢Ê€á´€á´ á´€á´„á´„á´á´œÉ´á´› Ò“ÉªÊ€sá´›
...
ðŸ“ž <b>á´„á´É´á´›á´€á´„á´› á´á´˜á´›Éªá´É´s:</b>
...
â€¢ sá´‡ssÉªá´É´ á´‡xá´˜ÉªÊ€á´‡á´…? Ê€á´‡-ÊŸá´É¢ÉªÉ´ Êá´á´œÊ€ á´€á´„á´„á´á´œÉ´á´›
â€¢ á´á´›á´˜ É´á´á´› Ê€á´‡á´„á´‡Éªá´ á´‡á´…? á´„Êœá´‡á´„á´‹ á´›á´‡ÊŸá´‡É¢Ê€á´€á´ á´€á´˜á´˜
â€¢ 2Ò“á´€ Ê€á´‡Ç«á´œÉªÊ€á´‡á´…? á´‡É´á´›á´‡Ê€ Êá´á´œÊ€ á´„ÊŸá´á´œá´… á´˜á´€ssá´¡á´Ê€á´…</blockquote>
"""
...
async def show_settings(query, user_id):
    ...
    mode_text = "ðŸ“±ðŸ“± Multiple" if use_multiple else "ðŸ“± Single"
    forward_text = "âœ‰ï¸ Forward" if use_forward else "ðŸ“¤ Send"
    auto_reply_text = "ðŸŸ¢ ON" if auto_reply else "ðŸ”´ OFF"
    auto_join_text = "ðŸŸ¢ ON" if auto_group_join else "ðŸ”´ OFF"

    settings_text = f"""
<b>âš™ï¸ sá´‡á´›á´›ÉªÉ´É¢s</b>

<b>ðŸ“Š Current Configuration:</b>

ðŸ”¹ <b>Account Mode:</b> {mode_text}
ðŸ”¹ <b>Message Mode:</b> {forward_text}
ðŸ”¹ <b>Auto Reply:</b> {auto_reply_text}
ðŸ”¹ <b>Auto Join:</b> {auto_join_text}
...
async def toggle_forward_mode(query, user_id):
    ...
    accounts = db.get_accounts(user_id, logged_in_only=True)
    if not accounts:
        await query.answer("âš ï¸ No accounts connected. Add an account first.", show_alert=True)
        return
    acc = accounts[0]
    ...
    if new_mode:
        ...
        mode_text = "<b>ðŸ“¤ sá´‡É´á´… á´á´á´…á´‡</b>"
...
async def show_auto_reply_menu(query, user_id):
    ...
    status = "ðŸŸ¢ ON" if auto_reply else "ðŸ”´ OFF"
    text_type = "Custom" if is_custom else "Default"

    menu_text = f"""
<b>ðŸ’¬ á´€á´œá´›á´ Ê€á´‡á´˜ÊŸÊ sá´‡á´›á´›ÉªÉ´É¢s</b>

<b>ðŸ“Š Current Configuration:</b>

ðŸ”¹ <b>Status:</b> {status}
ðŸ”¹ <b>Text Type:</b> {text_type}
...
async def toggle_auto_reply(query, user_id):
    accounts = db.get_accounts(user_id, logged_in_only=True)
    if not accounts:
        await query.answer("âš ï¸ No accounts connected.", show_alert=True)
        return
    acc = accounts[0]
    s = db.get_account_settings(acc["id"]) or {}
    ...
    status = "ðŸŸ¢ ON" if new_mode else "ðŸ”´ OFF"
    result_text = f"""
<b>ðŸ’¬ á´€á´œá´›á´ Ê€á´‡á´˜ÊŸÊ</b>
...
async def set_default_reply_text(query, user_id):
    ...
    result_text = f"""
<b>ðŸ“ á´…á´‡Ò“á´€á´œÊŸá´› á´›á´‡xá´› sá´‡á´›</b>
...
async def prompt_add_reply_text(query, user_id):
    ...
    prompt_text = """
<b>âž• á´€á´…á´… Ê€á´‡á´˜ÊŸÊ á´›á´‡xá´›</b>

ðŸ“ <b>Send your custom auto-reply text:</b>
...
async def delete_reply_text(query, user_id):
    ...
    if not current_text:
        result_text = """
<b>âŒ É´á´ á´„á´œsá´›á´á´ á´›á´‡xá´›</b>
...
async def view_reply_text(query, user_id):
    ...
    result_text = f"""
<b>ðŸ‘ï¸ á´„á´œÊ€Ê€á´‡É´á´› Ê€á´‡á´˜ÊŸÊ á´›á´‡xá´›</b>

<b>ðŸ“Š Type:</b> {text_type}
...
async def toggle_auto_group_join(query, user_id):
    ...
    status = "ðŸŸ¢ ON" if new_mode else "ðŸ”´ OFF"
    result_text = f"""
<b>ðŸ”— á´€á´œá´›á´ É¢Ê€á´á´œá´˜ á´Šá´ÉªÉ´</b>
...
async def show_selected_groups_menu(query, user_id):
    ...
    menu_text = f"""
<b>ðŸŽ¯ sá´‡ÊŸá´‡á´„á´›á´‡á´… É¢Ê€á´á´œá´˜s</b>

<b>ðŸ“Š Selected Groups:</b> <code>{len(target_groups)}</code>

âž• Add groups by ID
âž– Remove groups
ðŸ“‹ View all selected
"""
...
async def prompt_add_target_group(query, user_id):
    ...
    prompt_text = """
<b>âž• á´€á´…á´… É¢Ê€á´á´œá´˜</b>

<i>Send the Group ID to add:</i>

<b>ðŸ’¡ How to get Group ID:</b>
...
ðŸ—‘ï¸ Group <code>{group_id}</code> removed successfully.
"""
    else:
        result_text = f"""
<b>âŒ á´‡Ê€Ê€á´Ê€</b>
...
async def show_remove_target_groups(query, user_id, page=0):
    ...
    await send_new_message(
        query,
        "<b>ðŸ—‘ï¸ Select a group to remove:</b>",
...
async def clear_all_target_groups(query, user_id):
    ...
    result_text = f"""
<b>ðŸ—‘ï¸ É¢Ê€á´á´œá´˜s á´„ÊŸá´‡á´€Ê€á´‡á´…</b>

âœ… Removed <code>{count or 0}</code> groups from target list.
"""
    await send_new_message(query, result_text, selected_groups_keyboard())
...
async def view_target_groups(query, user_id, page=0):
    ...
    await send_new_message(
        query,
        f"<b>ðŸ“‹ Targeted Groups ({len(target_groups)})</b>",
...
async def show_delete_accounts(query, user_id, page=0):
    ...
    await send_new_message(
        query,
        "<b>ðŸ—‘ï¸ Select an account to delete:</b>",
...
async def show_load_groups_options(query):
    ...
    options_text = """
<b>ðŸ“‚ ÊŸá´á´€á´… É¢Ê€á´á´œá´˜s/á´á´€Ê€á´‹á´‡á´›á´˜ÊŸá´€á´„á´‡s</b>
...
async def load_groups(query, user_id):
    ...
    if len(accounts) == 1:
        ...
        if not result["success"]:
            await send_new_message(
                query,
                f"<b>âŒ Error loading groups</b>\n\n{result.get('error', 'Unknown error')}",
                main_menu_keyboard()
            )
            return
        ...
        groups_text = f"""
<b>ðŸ“‚ É¢Ê€á´á´œá´˜s & á´á´€Ê€á´‹á´‡á´›á´˜ÊŸá´€á´„á´‡s</b>

ðŸ‘¥ <b>Groups:</b> <code>{len(result['groups'])}</code>
ðŸª <b>Marketplaces:</b> <code>{len(result['marketplaces'])}</code>
ðŸ“Š <b>Total:</b> <code>{result['total']}</code>
"""
        await send_new_message(query, groups_text, groups_keyboard(all_chats, account_id))
    else:
        await send_new_message(
            query,
            "<b>ðŸ“‚ Select an account to load groups:</b>",
    ...
    try:
        ...
        if not logs_channel or not logs_channel.get('verified'):
            await send_new_message(
                ...
                "<blockquote>Êá´á´œ á´á´œsá´› sá´‡á´› á´œá´˜ á´€É´á´… á´ á´‡Ê€ÉªÒ“Ê á´€ ÊŸá´É¢s á´„Êœá´€É´É´á´‡ÊŸ Ê™á´‡Ò“á´Ê€á´‡ á´€á´œá´›á´-á´Šá´ÉªÉ´ÉªÉ´É¢ É¢Ê€á´á´œá´˜s.</blockquote>\n\n"
...
âŒ Failed: <code>{result['failed']}</code>
ðŸ“Š Total: <code>{result['total']}</code>
...
"""
    ...
    stats_text = "<b>ðŸ“Š Êá´á´œÊ€ á´€á´„á´„á´á´œÉ´á´› sá´›á´€á´›Éªsá´›Éªá´„s</b>\n\n"
    ...
    for account in accounts:
        ...
        stats_text += f"""
<b>ðŸ“± {display_name[:30]}</b>
âœ… Sent: <code>{sent}</code> | âŒ Failed: <code>{failed}</code>
ðŸ‘¥ Groups: <code>{groups}</code> | ðŸ’¬ Replies: <code>{replies}</code>
ðŸ”— Joined: <code>{joined}</code>
"""

    stats_text += f"""
<b>ðŸ“± Total Accounts:</b> <code>{len(accounts)}</code>
"""
    await send_new_message(query, stats_text, back_to_settings_keyboard())
...
async def show_ad_text_menu(query, user_id):
    ...
    ad_status = "âœ… Set" if ad_text else "âŒ Not Set"

    menu_text = f"""
<b>ðŸ“ á´€á´… á´›á´‡xá´› á´á´‡É´á´œ</b>

ðŸ“ <b>Ad Text:</b> {ad_status}
...
async def delete_ad_text(query, user_id):
    ...
    result_text = """
<b>ðŸ—‘ï¸ á´€á´… á´›á´‡xá´› á´…á´‡ÊŸá´‡á´›á´‡á´…</b>
...
ðŸ“± Using your only account for advertising.
"""
        user = db.get_user(user_id)
        ...
        await send_new_message(
            query,
            "<b>ðŸ“± Select an account for single mode:</b>",
...
async def set_multiple_mode(query, user_id, context):
    ...
    await send_new_message(
        query,
        "<b>ðŸ“±ðŸ“± Select accounts for multiple mode:</b>",
...
async def toggle_account_selection(query, user_id, account_id, context):
    ...
    await send_new_message(
        query,
        f"<b>ðŸ“±ðŸ“± Selected: {len(selected)} accounts</b>",
...
async def confirm_account_selection(query, user_id, context):
    ...
    if len(selected) < 2:
        await send_new_message(
            query,
            "<b>âŒ Select at least 2 accounts</b>",
...
ðŸ“±ðŸ“± Using <b>{len(selected)}</b> accounts for advertising.
"""
...
async def show_my_accounts(query, user_id, page=0):
    ...
    await send_new_message(
        query,
        f"<b>ðŸ“‹ Your Accounts ({len(accounts)})</b>",
...
async def start_advertising(query, user_id, context):
    ...
    if not logs_channel or not logs_channel.get('verified'):
        await send_new_message(
            query,
            "<b>âš ï¸ ÊŸá´É¢s á´„Êœá´€É´É´á´‡ÊŸ Ê€á´‡Ç«á´œÉªÊ€á´‡á´…</b>\n\n"
            "<blockquote>Êá´á´œ á´á´œsá´› sá´‡á´› á´œá´˜ á´€ ÊŸá´É¢s á´„Êœá´€É´É´á´‡ÊŸ Ê™á´‡Ò“á´Ê€á´‡ sá´›á´€Ê€á´›ÉªÉ´É¢ á´€á´…á´ á´‡Ê€á´›ÉªsÉªÉ´É¢.</blockquote>\n\n"
            "<b>Êœá´á´¡ á´›á´ sá´‡á´› á´œá´˜:</b>\n"
            "1. á´„Ê€á´‡á´€á´›á´‡ á´€ É´á´‡á´¡ á´„Êœá´€É´É´á´‡ÊŸ\n"
            "2. á´€á´…á´… á´›ÊœÉªs Ê™á´á´› á´€s á´€á´…á´ÉªÉ´\n"
            "3. É¢á´ á´›á´ sá´‡á´›á´›ÉªÉ´É¢s â†’ ÊŸá´É¢s á´„Êœá´€É´É´á´‡ÊŸ\n"
    ...
    start_text = f"""
<b>ðŸš€ á´€á´…á´ á´‡Ê€á´›ÉªsÉªÉ´É¢ sá´›á´€Ê€á´›á´‡á´…</b>

ðŸ“± <b>Accounts:</b> <code>{len(active_accounts)}</code>
âœ‰ï¸ <b>Mode:</b> <code>{mode_text}</code>
ðŸŽ¯ <b>Target:</b> <code>{target_text}</code>
...
async def handle_otp_input(query, user_id, data, context):
    ...
    if action == "cancel":
        if user_id in user_states:
            del user_states[user_id]
        await send_new_message(query, "<b>âŒ Login cancelled</b>", main_menu_keyboard())
        return
    ...
    if action == "submit":
        ...
        if result["success"]:
            ...
            await send_new_message(
                query,
                f"<b>âŒ Error:</b> {result.get('error', 'Unknown error')}",
                otp_keyboard()
            )
        return
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if current_state == "awaiting_api_id":
        ...
        try:
            ...
            if seconds < 10:
                await update.message.reply_text(
                    "<b>âŒ Time must be at least 10 seconds</b>",
                    parse_mode="HTML"
                )
                return
...
ðŸ“± <b>Total Accounts:</b> <code>{total_accounts}</code>
...
async def toggle_force_sub(query, user_id):
    ...
    status = "ðŸŸ¢ ON" if new_state else "ðŸ”´ OFF"
    result_text = f"""
...
async def view_force_sub_settings(query, user_id):
    ...
    status = "ðŸŸ¢ ON" if enabled else "ðŸ”´ OFF"
...
async def verify_logs_channel_callback(query, user_id):
    ...
    if not logs_channel:
        await query.answer("âŒ No logs channel set!", show_alert=True)
        return

    channel_id = logs_channel.get('channel_id')
    
    if not channel_id:
        await query.answer("âŒ Channel ID not found!", show_alert=True)
        return
    ...
    try:
        ...
        await query.answer("âŒ Failed to verify channel. Make sure bot is admin with post permissions.", show_alert=True)
        await send_new_message(
            query,
            "<b>âŒ á´ á´‡Ê€ÉªÒ“Éªá´„á´€á´›Éªá´É´ Ò“á´€ÉªÊŸá´‡á´…</b>\n\n<i>Please make sure:</i>\n1. Bot is added as admin to the channel\n2. Bot has permission to send messages\n3. The channel ID is correct",
...
async def toggle_force_join_callback(query, user_id):
    ...
    status_text = "ðŸŸ¢ ON" if new_status else "ðŸ”´ OFF"
